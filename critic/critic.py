...
sys.path.insert(0, '.')
from critic.perturbations import get_local_neighbors_char_level, \
...
def run_gpt2(sents, cuda=True, model_name=None):
    ...
    loss = get_gpt2_loss(input_ids=inputs['input_ids'],
...
def gpt2_critic_char_level_only(sent, verbose=1, cuda=True, fp16=True,
    ...
    is_good = True
    for _ in range(1):
        sent_perturbations = get_local_neighbors_char_level(sent,
...
def gpt2_critic(
    ...
    for _ in range(1):
        ...
        sent_perturbations_c = get_local_neighbors_char_level(orig_sent,
